...
echo "<script>location.href='matricula-online.html'</script>"; 
...
<p><b>Mensagem:</b> $nome</p> está interessado no curso de </b> $cpf</p>, pretende começar no mês de $data e conheceu a autoescola por </b> $conheceu</p>.
...
echo "<script>location.href='pagamento-online.html'</script>"; // Página que será redirecionada
